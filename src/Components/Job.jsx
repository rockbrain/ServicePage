          ...
          <p className="text-center  p-2 max-w-2xl mb-2 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400 ">I specialize in UI/UX & Graphic Design and 
            ...
            <div className="container m-auto grid grid-flow-row md:grid-cols-3 md:grid-flow-col gap-8 mt-[50px] z-10 w-[90%]">
              ...
              <JobsComponent/>
                ...
                <div className="work m-auto w-[90%]  h-[100%]  bg-slate-50 p-4 rounded-md shadow-lg">
                    <div className=" pb-8 flex w-fit font-bold text-sm text-red-500">
              ...
              <div className="tools m-auto w-[90%] h-[100%]  bg-slate-50 p-4 rounded-md shadow-lg">
                  <div className="pb-8 flex w-fit font-bold text-sm text-green-500">
