...
const WorkProcess = () =>{
    ...
    <div className="sm:large-screens-responsive px-2 py-8 grid grid-cols-1 md:grid-cols-2 grid-gap-4 md:gap-12 w-[90%] m-auto h-[80%] bg-white rounded-2xl ">
            <div className="grid">
                <div>
                <h1  className="text-center text-2xl/8 pb-4">💼 LET'S WORK TOGETHER! </h1>
                <p  className="text-center max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">I am taking on new projects. Waiting to hear about new projects, 
               ...
               <h1 className="text-2xl/8 pb-4">WORKING PROCESS</h1>
                ...
                <div className="flex justify-center flex-auto flex-wrap ">
                    ...
                    <div className="flex justify-start rounded-md mb-2  items-center mr-4 w-[220px] bg-[#F5F6F7] h-[50px]">
                        <p class="text-sm pl-4">🤝 1. Project Introduction</p>
                    </div>
                    <div className="flex justify-start rounded-md mb-2  items-center mr-4 w-[220px] bg-[#F5F6F7] h-[50px]">
                        <p class="text-sm pl-4 ">🖌️ 2. Visual Design</p>
                    </div>
                    <div className="flex justify-start rounded-md mb-2  items-center mr-4  w-[220px] bg-[#F5F6F7] h-[50px]">
                        <p class="text-sm  pl-4">💻️ 3. Webflow Development</p>
                    </div>
                    <div className="flex justify-start  rounded-md mb-2 items-center mr-4 w-[220px]  bg-[#F5F6F7] h-[50px]  ">
                        <p class="text-sm pl-4">👍️ 3. Revision & Delivery</p>
                    </div>
                </div>
            </div>
        </div> 
